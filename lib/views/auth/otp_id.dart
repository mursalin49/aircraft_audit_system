...
class OtpIdVerificationScreenLegacy extends StatefulWidget {
  const OtpIdVerificationScreenLegacy({super.key});

  @override
  State<OtpIdVerificationScreenLegacy> createState() => _OtpIdVerificationScreenLegacyState();
}

class _OtpIdVerificationScreenLegacyState extends State<OtpIdVerificationScreenLegacy> {
