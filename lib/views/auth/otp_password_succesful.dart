...
import 'package:avislap/views/auth/reset_password.dart';
...
class OtpPasswordSuccessScreen extends StatefulWidget {
  const OtpPasswordSuccessScreen({super.key});

  @override
  State<OtpPasswordSuccessScreen> createState() => _OtpPasswordSuccessScreenState();
}

class _OtpPasswordSuccessScreenState extends State<OtpPasswordSuccessScreen>
